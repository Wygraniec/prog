    ...
    public static void main(String[] args) {
        ...
        if(debug) {
            ...
            switch(selection) {
                ...
                case 4:  System.out.println("Najmniejsza wartość: " + arr.minVal()); break;

                case 5:  System.out.println("Największa wartość: " + arr.maxVal()); break;

                case 6:System.out.println("Średnia liczb w tablicy: " + arr.average()); break;

                case 7: System.out.println("Mediana liczb w tablicy: " + arr.median()); break;
